...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "Chambers OS — AI for Legal Professionals" },
      { property: "og:description", content: "Draft legal emails, summarize meetings, plan tasks, and research faster with AI built for lawyers." },
